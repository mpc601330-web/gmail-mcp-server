...
export class StateStore {
  ...
  load(): CollectorState { try{return JSON.parse(readFileSync(this.path,"utf8"));}catch(error){if((error as NodeJS.ErrnoException).code==="ENOENT")return {};throw new Error("Operational state is unreadable; refusing to reset checkpoint");} }
